const Header = () => {
  return (
    <section className="text-center p-20 md:p-32 lg:p-48">
      ...
      <button className="transition-all bg-gradient-to-r from-gray-900 to-purple-950  text-white rounded-full px-4 py-2 font-semibold border border-purple-900  active:border-slate-400">
        Start Browsing
      </button>
    </section>
  );
